...
configCustom.deep_merge!(YAML.load_file("#{dir}/projects/pm_3deluxe/config.yaml"))
configCustom.deep_merge!(YAML.load_file("#{dir}/projects/wordpress-default/config.yaml"))
